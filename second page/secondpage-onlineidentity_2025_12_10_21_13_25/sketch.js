...
function preload() {
  ...
  imgs[0] = loadImage('coat1 copy.png');   // PUT IMAGE LINK HERE
  imgs[1] = loadImage('coat2 copy.png');   // PUT IMAGE LINK HERE
  imgs[2] = loadImage('pant1 copy.png'); // PUT IMAGE LINK HERE
  imgs[3] = loadImage('pant2 copy.png');  // PUT IMAGE LINK HERE
  imgs[4] = loadImage('shoe1 copy.png');  // PUT IMAGE LINK HERE
  imgs[5] = loadImage('shoe2 copy.png');  // PUT IMAGE LINK HERE
}
