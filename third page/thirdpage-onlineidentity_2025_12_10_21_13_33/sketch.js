let imgs = [];
let numRows = 12; // increased from 6 to 10 (adds 4 more rows)
let numCols = 12;  // number of squares horizontally
let squareSize;
let colorPalette = [];

function preload() {
  // Load 4 different images
  imgs[0] = loadImage('pant1copy.png');   // PUT IMAGE LINK HERE
  imgs[1] = loadImage('pant2copy.png');   // PUT IMAGE LINK HERE
  imgs[2] = loadImage('shoe1copy.png'); // PUT IMAGE LINK HERE
  imgs[3] = loadImage('shoe2copy.png');  // PUT IMAGE LINK HERE
  imgs[4] = loadImage('top1copy.png');  // PUT IMAGE LINK HERE
  imgs[5] = loadImage('top2copy.png');  // PUT IMAGE LINK HERE
}
